...
public class ChurchDistrict {
    ...
    public void squireRankup(Player user) {
        ...
        Functions.delay(3000);
        System.out.println(
                "\nThe Priest walks around and sits at his desk chair and invites you to sit in one of the chairs facing him. As you do, the Priest begins to explain.\n\nPriest: \"Because of your recent promotion, you will be tending to one of our knights into battle. Polishing\nhis armor, sharpening his sword, whatever he requires you to do, you must do it. Of course, if the action that\nyour knight is forcing you to do can be deemed immoral by the High Council of the Church, then you have full\nfreedom to not follow through with the order. When you are ready, go South, to the Badlands. There will be your\nfirst assignment.");
        Functions.delay(3000);
        System.out.print(
