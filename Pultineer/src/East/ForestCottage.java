        ...
        while (!input.toLowerCase().contains("shop") || !input.toLowerCase().contains("back")
            ...
            if (input.toLowerCase().contains("shop") || input.toLowerCase().contains("continue")) {
                ...
                do {
                    ...
                    // Health Potion
                    else if (getShop()[0][0].isEmpty() == false) {
                                if(input.toLowerCase()
                                .contains(getShop()[0][0].toLowerCase())){
                        int storeCost = Integer.parseInt(getShop()[0][1]);
                        if (user.getGold() >= storeCost) {
                            user.setGold(user.getGold() - storeCost);

                            // Drink potion and add buff to player
                            if(getShop()[0][0].toLowerCase().contains("health")){
                            user.setTotalHealth(user.getTotalHealth() + Integer.parseInt(shop[0][2]));
                            System.out.println(
                    ...
                    // Strength Potion
                    else if (getShop()[1][0].isEmpty() == false) {
                                if(input.toLowerCase()
                    ...
                    // Speed Potion
                    else if (getShop()[2][0].isEmpty() == false) {
                                if(input.toLowerCase()
                    ...
                    // Hardiness Potion
                    else if (getShop()[3][0].isEmpty() == false) {
                                if(input.toLowerCase()
                    ...
                    } while (repeat == true); // End of if(keepShopping)
            ...
            // Talk
            // ! if (input.tolower contains "back" and user Rank is follower and user accepted quest)
            ...
            // ! if (input.toLower does not contain "shop", "back", and "exit")
                    ...
                    && !input.toLowerCase().contains("exit") && !input.toLowerCase().contains("no") && user.getQuestAccepted() == false) {
                System.out.println(
                        "\nGherald: I'm sorry, I didn't quite catch that. Could you repeat yourself?(Shop/Back)\n");
                input = keys.nextLine();
            }
        }
    }// End of while(input != shop, back, or continue)
