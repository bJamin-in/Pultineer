    ...
    public static boolean teamBattle(String playerInput, boolean battleState, boolean gameState, Enemy[] enemies,
        ...
        while (battleState) {
            ...
            while (playerTurn) {
                ...
                // Teammates
                System.out.println("The " + teamType + "s stand at your side.");
                    ...
                    if (enemies[x].getHealth() > 0) {
                        ...
                        if (rnd.nextInt(2) + 1 == 1) {
                            ...
                            for (int counter = 0; counter < team.length; counter++) {
                                ...
                                else if(target <= team.length){
                                    System.out.println("The " + enemies[x].getName() + " " + (x + 1) + " attacks " + team[target].getName() + "!");
                                    team[target].setHealth(team[target].getHealth() - (enemies[x].getAttack() - team[target].getDefense()));
                                }
                                    else {
                                    System.out.println(
                                            "\n" + enemies[x].getName() + " " + (x + 1) + " misses it's attack!\n");
